## Smash Legends Visual Mode fork

This working tree includes a visual-only Smash Legends prototype: detection overlay, center points, opponent-distance line, distance label, and optional range circle. Automatic aim/trigger/input injection is not part of the intended Smash workflow. See `SMASH_LEGENDS_BUILD.md`.
